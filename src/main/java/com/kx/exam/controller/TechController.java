...
import com.kx.exam.service.TechService;
...
public class TechController extends BaseController{
	...
	/*@Authority(ifOper = "0",opCode = "0201", opName = "文件管理界面")
	...
	@ResponseBody
	@Authority(ifOper = "0",opCode = "020101", opName = "添加文件")
	public AjaxResult addFile(IFile file) {
		return techService.addFile(file);
	}

	@Authority(ifOper = "0",opCode = "020102", opName = "更新文件页面")
	...
	@ResponseBody
	@Authority(ifOper = "0",opCode = "020102", opName = "修改文件")
	...
	@ResponseBody
	@Authority(ifOper = "0",opCode = "020103", opName = "删除文件")
	public AjaxResult delFile(@PathVariable("id") int id) {
		return techService.delFile(id);
	}

	//==================================================文章管理==================================================
	@Authority(ifOper = "0",opCode = "0202", opName = "文章管理界面")
	...
	@ResponseBody
	@Authority(ifOper = "0",opCode = "0202", opName = "查询文章列表")
	...
	@Authority(ifOper = "0",opCode = "020201", opName = "添加文章页面")
	...
	@ResponseBody
	@Authority(ifOper = "0",opCode = "020202", opName = "修改文章")
	...
	@ResponseBody
	@Authority(ifOper = "0",opCode = "020203", opName = "删除文章")
	public AjaxResult delArticle(@PathVariable("id") int id) {
		return techService.deleteByID(id);
	}

	//==================================================文章管理==================================================
	@Authority(ifOper = "0",opCode = "0203", opName = "测试界面")
