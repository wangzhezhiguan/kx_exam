package com.kx.exam.common.aspect;
...
public class LogAspect {
	...
	// Service层切点
	@Pointcut("@annotation(com.kx.exam.common.annotation.ServiceLog)")
	public void serviceAspect() {
	}

	// Controller层切点
	@Pointcut("@annotation(com.kx.exam.common.annotation.ControllerLog)")
