...
layui.define(['element', 'common'], function (exports) {
    ...
    Tab.prototype.init = function () {
        ...
        /*var size = $container.html();
        if(size == 0) {
        	$container.html('<ul class="layui-tab-title"></ul><div class="layui-tab-content" style="min-height: 150px; padding: 5px 0 0 0;"></div>');
        }*/
     ...
     * @returns {Number}
     */
    Tab.prototype.removeAllTab = function () {
        var that = ELEM.titleBox === undefined ? this.init() : this;
        ELEM.titleBox.find('li').each(function (i, e) {
     ...
     * @returns {Number}
     */
    Tab.prototype.removeTabByLike = function (title) {
        var that = ELEM.titleBox === undefined ? this.init() : this,
            tabId = -1;
        ELEM.titleBox.find('li').each(function (i, e) {
            var $cite = $(this).children('cite');
            if ($cite.text().indexOf(title) != -1) {
                tabId = $(this).attr('lay-id');
                that.deleteTab(tabId);
            };
        });
    ...
    Tab.prototype.tabFlush = function (title) {
    	var that = this;
        var _config = that.config;
