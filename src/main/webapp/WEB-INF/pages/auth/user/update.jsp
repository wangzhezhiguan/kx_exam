...
<form id="submitForm" class="form-horizontal">
	<input name="opuserid" value="${user.opuserid}" type="text" hidden="hidden">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input class="form-control" type="text" id="opname" name="opname"  value="${user.opname}" required placeholder="请填写姓名"/>
