...
<div class="page-header" style="padding:10px 20px;margin:-18px 0px 0px">
  <div id="searchForm">
	...
	<select class="form-control" name="status">
		...
		<option value="8">未提现</option>
		<option value="9">已开通未提现</option>
		<option value="10">已提现</option>
        ...
        $("#openAppGrid").sgrid({
            columns:[
                ...
                {field:"status", text:"客户状态",formatter:function(index, content, data){
                				if(content == 1) 	return "<font color='blue'>启用</font>";
												else if(content == 2) 	return "<font color='blue'>业务员维护中</font>";
												else if(content == 0) 	return "<font color='blue'>刚注册客户</font>";
												else if(content == 3) 	return "<font color='blue'>区未覆盖</font>";
												else if(content == 13) 	return "<font color='blue'>已弃用</font>";
												else if(content == 4) 	return "<font color='blue'>审核分配中</font>";
												else if(content == 5) 	return "<font color='blue'>审核中</font>";
												else if(content == 6) 	return "<font color='blue'>待审经理批准</font>";
												else if(content == 14) 	return "<font color='blue'>停用</font>";
												else if(content == 15) 	return "<font color='blue'>已删除</font>";
												else if(content == 12) 	return "<font color='blue'>已提现</font>";
												else if(content == 9) 	return "<font color='blue'>未提现</font>";
												else if(content == 8) 	return "<font color='blue'>待维护老客户</font>";
												else if(content == 7) 	return "<font color='blue'>二次审核中</font>";
												else if(content == 11) 	return "<font color='blue'>已开通未提现</font>";
                }}, 
                ...
                {field:"userid", text:"操作",width:80, style:"text-align:center", formatter:function(index, content, data){
	                    ...
	                    return "&nbsp;<a href='javascript:showModal( \""+editUrl+"\");'  data-original-title='详情' class='btn btn-xs btn-success add-tooltip'><i class='fa fa-times'>查看详情</i></a>";
            ...
            cls: "",
            url: _urlPath + "admin/userinfo/myqueryPage",
            sort:"createdate",
            order:"desc",
            pagination:true,
            onLoad:function(){
