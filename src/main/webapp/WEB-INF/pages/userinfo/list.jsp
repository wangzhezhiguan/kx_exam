    ...
    $(function (){
        $("#openAppGrid").sgrid({
            ...
            {field:"rownum", text:"序列",formatter:function(index, content, data){
                ...
                {field:"oper_user.opname", text:"来源商户", sortColumn:"opuserid"},
               ...
               // }}, 
                ...
                //}}, 
                {field:"fromapp", text:"APP"},
                {field:"fromchannel", text:"来源渠道"},                
                //{field:"userid", text:"操作",width:80, style:"text-align:center", formatter:function(index, content, data){             
	                   // var editUrl = "admin/preUserUpdateOper/" + content;		      
	                    //return "&nbsp;<a href='javascript:showModal( \"重分配审核员\", \""+editUrl+"\");'  data-original-title='重分配审核员' class='btn btn-xs btn-warning add-tooltip'><i class='fa fa-edit'>重分配审核员</i></a>";
