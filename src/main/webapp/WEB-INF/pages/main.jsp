...
<script type="text/javascript">
	...
	function goIndex(gogo){
				if(gogo==0)
        window.location.href = "${ctx}/admin/main";
        else if(gogo==1)
        	window.location.href = "${ctx}/admin/mainElectric";
    }
	...
	new AjaxUpload(headBtn,{
		action: _urlPath+"/admin/uploadPic?type=1&opuserid=" + ${loginUser.opuserid},
		name: "picfile",
		responseType: "json",
