...
<div class="col-md-1 no-padding">
    <button id="cancelHasOperationBtn" class="btn btn-labeled btn-danger"><span class="btn-label icon fa fa-unlink">取消</span></button>
</div>
<div class="col-md-11">
...
<script type="text/javascript">
    ...
    cancelHasOperations = function(){
        ...
        if (data != ""){
            $.ajax({
                url:_urlPath + "admin/roleunbindOpers",
                data:data,
                type:"post",
                dataType:"json",
