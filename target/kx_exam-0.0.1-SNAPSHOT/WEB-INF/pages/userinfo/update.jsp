        ...
        <div class="col-sm-8">
            <div class="radio">
				<label style="display: inline-block; width: 50px;">
					<input checked value="1" <c:if test="${1==user.sex}">selected</c:if>  name="sex" type="radio" class="ace"/>男♂
				</label>
				<label style="display: inline-block; width: 50px;">
					<input value="0" name="sex" <c:if test="${0==user.sex}">selected</c:if>  type="radio" class="ace"/>女♀
				</label>
			</div>
        </div>
    </div>
...
<script type="text/javascript">
	submit = function(){
		...
		ajaxRequest("admin/userinfoUpdate", data);
	}
</script>